...
main_url = base_url + "himenu.shtml"
...
try:
    ...
    for link in all_links:
        ...
        if link.text.strip().lower() == 'career':
            ...
            #If the href starts with the base_url (https://www.baseball-almanac.com/) + hitting/ then add it to career_links list
            if href and href.startswith(base_url + "hitting/"):
